...
**Статус: в работе — Phase 0–2 выполнены (стенд из 14 нод и все общие зависимости подняты), дальше Phase 3 (Harbor в HA)** (создан 2026-09-24). База — `harbor-on-kind` @ `b65df71`: рабочая одно-нодовая лаборатория. Её миграционный backlog (Kind 0.17 → 0.30, K8s 1.26 → 1.34, Harbor 2.8 → 2.15.2; Phase 0–6, все закрыты) сохранён в git-истории этого репозитория и в https://github.com/it255ru/harbor-on-kind.
