...
# metallb
helm upgrade -i metallb metallb/metallb --version 0.16.1 -f $CURDIR/config/metallb.yaml
...
# nginx
helm upgrade -i ingress-nginx ingress-nginx/ingress-nginx --version 4.15.1 -f $CURDIR/config/nginx.yaml
